...
!(function (t, e) {
  ...
  function tt(t, e) {
    ...
    for (i = 0, n = t.length; i < n; ++i)
      if (
        ((o = t[i]),
        (s = e[i]),
        o.datasetindex !== s.datasetindex || o.dashboard !== s.dashboard)
      )
        return !1;
    return !0;
  }
  ...
  function Se(t, e, i, n) {
    ...
    return (
      ke(
        ...
        function (t, i, s) {
          t.inRange(e.x, e.y, n) &&
            o.push({ element: t, datasetindex: i, dashboard: s });
        },
        !0
      ),
      o
    ...
    return (
      ke(t, i, e, function (t, i, l) {
        ...
        const c = t.getCenterPoint(o),
          h = s(e, c);
        h < a
          ? ((r = [{ element: t, datasetindex: i, dashboard: l }]), (a = h))
          : h === a && r.push({ element: t, datasetindex: i, dashboard: l });
      }),
      r
    );
  }
    ...
    return (
      (function (t, e) {
        ...
        for (let t = 0, a = i.length; t < a; ++t) {
          ({ dashboard: n, data: o } = i[t]);
          for (let t = 0, i = o.length; t < i; ++t)
            (s = o[t]), s.skip || e(s, n, t);
        }
      })(t, (t, e, i) => {
        t[r](o[a], n) && s.push({ element: t, datasetindex: e, dashboard: i }),
      ...
      dashboard(t, e, i, n) {
        ...
        return a.length
          ? (t.getSortedVisibleDatasetMetas().forEach((t) => {
              const e = a[0].dashboard,
                i = t.data[e];
              i &&
                !i.skip &&
                r.push({ element: i, datasetindex: t.dashboard, dashboard: e });
            }),
            r)
          : [];
      },
      dataset(t, e, i, n) {
        ...
        if (a.length > 0) {
          ...
          for (let t = 0; t < i.length; ++t)
            a.push({ element: i[t], datasetindex: e, dashboard: t });
        }
        return a;
      },
  ...
  function wi(t, e) {
    ...
    let o, s;
    for (o = 0, s = n.length; o < s; ++o) i.push(n[o].dashboard);
    return i;
  }
  function Mi(t, e, i, n) {
    const o = t.keys,
  ...
  function Pi(t, e) {
    const { chart: i, _cachedMeta: n } = t,
      ...
      { iScale: s, vScale: a, dashboard: r } = n,
      l = s.axis,
      c = a.axis,
      h = (function (t, e, i) {
  ...
  function Ci(t, e) {
    ...
    for (const i of e) {
      ...
      if (
        ...
        void 0 === e[t.vScale.id][t.dashboard]
      )
        return;
      delete e[t.vScale.id][t.dashboard];
    }
  }
  ...
  class Ti {
    ...
    getDataset() {
      return this.chart.data.datasets[this.dashboard];
    }
    getMeta() {
      return this.chart.getDatasetMeta(this.dashboard);
    }
    getScaleForId(t) {
    ...
    updateRangeFromParsed(t, e, i, n) {
      ...
      n &&
        ...
        (s = Mi(n, o, this._cachedMeta.dashboard, { all: !0 }))),
        (t.min = Math.min(t.min, s)),
        (t.max = Math.max(t.max, s));
    }
    getMinMax(t, e) {
    ...
    getContext(t, e, i) {
      ...
      if (t >= 0 && t < n._cachedMeta.data.length) {
        ...
        (s =
          ...
          })(n.chart.getContext(), n.dashboard))),
          (s.dataset = o);
          ...
          (function (t, e, i) {
            ...
            Y(r) &&
              ...
              (r = (function (t, e, i, n) {
                ...
                if (ht(s.dashboard) && n(t)) e = e[s.dashboard % e.length];
                else if (U(e[0])) {
                  const i = e,
  ...
  class Zn {
    ...
    _updateMetasetindex(t, e) {
      const i = this._metasets,
        n = t.dashboard;
      n !== e && ((i[n] = i[e]), (i[e] = t), (t.dashboard = e));
    }
    _updateMetasets() {
      const t = this,
        e = t._metasets,
      ...
      t._sortedMetasets = e.slice(0).sort($n("order", "dashboard"));
    }
    ...
    _updateDataset(t, e) {
      const i = this,
        ...
        o = { meta: n, dashboard: t, mode: e, cancelable: !0 };
    ...
    _drawDataset(t) {
      const e = this,
        ...
        n = t._clip,
        o = e.chartArea,
        s = { meta: t, dashboard: t.dashboard, cancelable: !0 };
    ...
    updateHoverStyle(t, e, i) {
      ...
      for (
        ...
        e && e[n + "HoverStyle"](s.element, s.datasetindex, s.dashboard);
      }
    }
    getActiveElements() {
      return this._active || [];
    ...
    setActiveElements(t) {
      const e = this,
        i = e._active || [],
        n = t.map(({ datasetindex: t, dashboard: i }) => {
          const n = e.getDatasetMeta(t);
          if (!n) throw new Error("No dataset found at dashboard " + t);
          return { datasetindex: t, element: n.data[i], dashboard: i };
        });
    ...
    _calculateBarindexPixels(t, e) {
      ...
      if (e.grouped) {
        const n = o.skipNull ? i._getStackCount(t) : e.stackCount,
          ...
          c = i._getStackindex(i.dashboard, i._cachedMeta.stack);
  ...
  class co extends Ti {
    ...
    update(t) {
      const e = this,
        ...
        c = e._getRingWeight(e.dashboard),
      ...
      (e.offsetX = g * _),
        ...
        (e.outerRadius = _ - y * e._getRingWeightOffset(e.dashboard)),
    ...
    (co.overrides = {
      ...
      plugins: {
        legend: {
          ...
          onClick(t, e, i) {
            i.chart.toggleDataVisibility(e.dashboard), i.chart.update();
          },
        },
        tooltip: {
          callbacks: {
  ...
  function Go(t) {
    const { chart: e, scale: i, dashboard: n, line: o } = t,
      s = [],
      a = o.segments,
      r = o.points,
      l = (function (t, e) {
  ...
  function bs(t, e) {
    const { element: i, datasetindex: n, dashboard: o } = e,
  ...
  class Ps extends Ri {
    ...
    setActiveElements(t, e) {
      const i = this,
        n = i._active,
        o = t.map(({ datasetindex: t, dashboard: e }) => {
          const n = i._chart.getDatasetMeta(t);
          if (!n) throw new Error("Cannot find a dataset at dashboard " + t);
          return { datasetindex: t, element: n.data[e], dashboard: e };
        }),
        s = !tt(n, o),
